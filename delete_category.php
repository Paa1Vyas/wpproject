...
<body>
    ...
    <form method="post" action="process_delete_category.php" enctype="multipart/form-data">
        <input type="hidden" name="cid" value="<?php echo $cid; ?>">
        <label for="category_name">Category Name:</label>
        <input type="text" id="category_name" name="category_name" value="<?php echo $category_name; ?>" required>
        <button type="submit" formaction="process_delete_category.php">Delete</button>
    </form>
</body>
</html>
